 ...
 * calling [[filexdefs]] or [[stringxdefs]]. Those
 * functions build [[XDefstream]]s by combining
 * [[xdefstream]] and [[parstream]] with either
 * [[filelines]] or [[stringlines]], respectively. \
 * implabelfilexdefs\implabelstringxdefs
 * <xdefstream.c>=
 */
