...
Namelist freevars(Exp e, Namelist bound, Namelist free) {
    ...
    /* extra cases for finding free variables in {\uscheme} expressions 1215b */
    case BREAKX:
        break;
    case CONTINUEX:
        break;
    ...
    case TRY_CATCH:
        ...
        break;
    /* extra cases for finding free variables in {\uscheme} expressions 1216 */
    case HOLE:
    case CALLENV:
    case LETXENV:
...
void printexp(Printbuf output, va_list_box *box) {
    ...
    /* extra cases for printing {\uscheme} ASTs 1215a */
    case BREAKX:
        bprint(output, "(break)");
        break;
    case CONTINUEX:
