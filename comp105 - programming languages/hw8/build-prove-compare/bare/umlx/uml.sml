...
(* Hindley-Milner types with generated type constructors 616d *)
(* \small [[tycon]], [[freshTycon]], [[eqTycon]], and [[tyconString]] for generated type constructors 601a *)
type tycon_identity = int
(* \small [[tycon]], [[freshTycon]], [[eqTycon]], and [[tyconString]] for generated type constructors 601b *)
type tycon = { printName : name, identity : tycon_identity }
(* \small [[tycon]], [[freshTycon]], [[eqTycon]], and [[tyconString]] for generated type constructors 601c *)
fun eqTycon ({ identity = id, printName = _ }, { identity = id', printName = _ }
                                                                             ) =
  id = id'
(* type declarations for consistency checking *)
val _ = op eqTycon : tycon * tycon -> bool
(* \small [[tycon]], [[freshTycon]], [[eqTycon]], and [[tyconString]] for generated type constructors 601d *)
fun tyconString { identity = _, printName = T } = T
(* \small [[tycon]], [[freshTycon]], [[eqTycon]], and [[tyconString]] for generated type constructors 601e *)
local
...
(* \small [[tycon]], [[freshTycon]], [[eqTycon]], and [[tyconString]] for generated type constructors 602a *)
local
...
(* shared utility functions on Hindley-Milner types 609a *)
...
(* shared utility functions on Hindley-Milner types 609b *)
...
(* specialized environments for type schemes 597b *)
...
(* extensions that support existential types 624 *)
...
(* extensions that support existential types 625a *)
fun freshSkolem _ =
...
(* extensions that support existential types 627c *)
...
(* extensions that support existential types 627d *)
...
(* extensions that support existential types 627e *)
...
(* abstract syntax and values for \uml 587a *)
...
(* kinds for typed languages 1295b *)
fun kindString TYPE = "*"
  | kindString (ARROW (ks, k)) =
      "(" ^ spaceSep (map kindString ks @ ["=>", kindString k]) ^ ")"
(* definition of [[tyex]] for \uml 585a *)
...
(* definitions of [[exp]] and [[value]] for \uml 586a *)
datatype exp 
  = LITERAL    of value
  | VAR        of name
  | VCONX      of vcon
...
(* definitions of [[exp]] and [[value]] for \uml 586d *)
and value
...
(* definition of [[def]] for \uml 586b *)
...
(* definition of [[implicit_data_def]] for \uml 1300b *)
datatype implicit_data_def 
  = IMPLICIT_DATA of tyvar list * name * implicit_vcon list
and implicit_vcon 
  = IMPLICIT_VCON of vcon * tyex list
(* definition of [[unit_test]] for languages with Hindley-Milner types and generated type constructors 586c *)
...
(* definition of [[valueString]] for \uml 1294b *)
...
(* definition of [[valueString]] for \uml 1294c *)
and consString (v, vs) =
...
fun expString e =
  ...
  in  case e
        of LITERAL v => valueString v
         ...
         (* extra cases of [[expString]] for \uml 1294d *)
         | VCONX vcon => vcon
         | CASE (e, matches) =>
...
(* clauses for [[defName]] for forms found only in \uml ((elided)) (THIS CAN'T HAPPEN -- claimed code was not used) *)
  (*empty*)
(* definition of [[tyexString]] for \uml 1295a *)
...
(* utility functions on \uml\ values ((uml)) 615a *)
...
(* utility functions on \uml\ values ((uml)) 616a *)
...
(* lexical analysis and parsing for \uml, providing [[filexdefs]] and [[stringsxdefs]] 1281a *)
...
(* parsers for Hindley-Milner types with generated type constructors 1281b *)
fun tyex tokens = (
     TYNAME <$> tyname
 <|> TYVARX <$> tyvar
 <|> usageParsers
...
(* parsers for Hindley-Milner types with generated type constructors 1281c *)
fun kind tokens = (
  TYPE <$ eqx "*" vvar
...
(* parsers and [[xdef]] streams for \uml 1282d *)
fun pattern tokens =  (
                WILDCARD    <$  eqx "_" vvar
      <|>       PVAR        <$> vvar
...
(* parsers and [[xdef]] streams for \uml 1283a *)
...
(* parsers and [[xdef]] streams for \uml 1283b *)
(* utility functions that help implement \uml's syntactic sugar ((prototype)) 1286d *)
fun freeIn exp y =
...
(* utility functions that help implement \uml's syntactic sugar 1286e *)
val varsupply = 
...
(* utility functions that help implement \uml's syntactic sugar 1287a *)
fun freshVars e xs =
  streamTake (length xs, streamFilter (not o freeIn e) varsupply)
(* type declarations for consistency checking *)
val _ = op freshVars : exp -> 'a list -> name list
(* utility functions that help implement \uml's syntactic sugar 1287b *)
...
(* utility functions that help implement \uml's syntactic sugar 1287c *)
...
fun exptable exp =
  let (* parsers used in both flavors *)
      ...
      (* \uml\ expression builders that expect to bind patterns 1287d *)
      (* you can redefine letx, lambda, and lambdastar here *)
  in  (* parsers for expressions that begin with keywords 1284a *)
      usageParsers
        ...
        (* rows added to \uml's [[exptable]] in exercises 1288c *)
        (* you add this bit *)
        ]
  end
(* parsers and [[xdef]] streams for \uml 1284b *)
...
(* parsers and [[xdef]] streams for \uml 1285a *)
(* definition of [[makeExplicit]], to translate [[implicit-data]] to [[data]] 1301a *)
...
(* parsers and [[xdef]] streams for \uml 1285b *)
val def = 
...
(* \uml\ definition builders that expect to bind patterns ((prototype)) 1287e *)
...
(* parsers and [[xdef]] streams for \uml 1286a *)
...
(* parsers and [[xdef]] streams for \uml 1286b *)
val xdeftable = usageParsers
  [ ("(use filename)", USE <$> any_name)
  (* rows added to \uml's [[xdeftable]] in exercises ((prototype)) 1287f *)
  (* you can add a row for 'val' here *)
  (* rows added to \uml's [[xdeftable]] in exercises 1288d *)
  (* you add this bit *)
  ]
(* type declarations for consistency checking *)
val _ = op xdeftable : xdef parser
(* parsers and [[xdef]] streams for \uml 1286c *)
...
(* parsers and [[xdef]] streams for \uml 1288a *)
local
...
(* definition of [[basis]] for \uml 611b *)
...
(* translation of {\uml} type syntax into types 603b *)
  ...
  | txType (TYVARX a, Delta) =
      (find (a, Delta)
       handle NotFound _ => raise TypeError ("type variable " ^ a ^
                                                            " is not in scope"))
(* translation of {\uml} type syntax into types 604 *)
      ...
      in  case k
            of ARROW (argks, resultk) =>
                 if eqKinds (ks, argks) then
                  ...
                  (* applied type constructor [[tx]] has the wrong kind 1301b *)
             ...
             | TYPE =>
                   (* type [[tau]] is not expecting any arguments 1301c *)
...
(* translation of {\uml} type syntax into types 605a *)
...
(* translation of {\uml} type syntax into types 606b *)
  | txTyScheme (tx, Delta) =
...
(* elaboration and evaluation of [[data]] definitions 592a *)
...
(* elaboration and evaluation of [[data]] definitions 608a *)
fun elabDataDef ((T, k, vcons), Gamma, Delta) =
  let val mu     = freshTycon T
      ...
      (* definition of [[validate]], for types of value constructors 610 *)
      fun validate (K, sigma as FORALL (alphas, _), mu, k) =
        let
          (* definitions of [[appliesMu]] and [[validateTypeArguments]] 1298e *)
            fun appliesMu (CONAPP (tau, _)) = eqType (tau, TYCON mu) 
              | appliesMu _ = false

          (* definitions of [[appliesMu]] and [[validateTypeArguments]] 1299a *)
      ...
      (* for [[K]], complain that [[alphas]] is inconsistent with [[k]] 1299b *)
                (case k
                   of TYPE =>
      ...
      val _ = op validateLengths       : tyvar list * kind list -> unit
        in
(* validation by case analysis on [[schemeShape shape]] and [[k]] ((existentials)) 1300a *)
            ...
            (* type of [[K]] should be [[desiredType]] but is [[sigma]] 1299c *)
    ...
    (* result type of [[K]] should be [[desiredType]] but is [[result]] 1299d *)
...
(* elaboration and evaluation of [[data]] definitions 612b *)
fun processDataDef (dd, (Gamma, Delta, rho), interactivity) =
  let val (Gamma', Delta', tystrings) = elabDataDef (dd, Gamma, Delta)
      ...
      val _ = if prints interactivity then
                (* print the new type and each of its value constructors 612c *)
                let val (T, _, _) = dd
...
(* definitions of [[emptyBasis]], [[predefinedTypeBasis]], [[booltype]], [[listtype]], and [[unittype]] 613a *)
...
val primTyconBasis : basis = 
  foldl addTycon emptyBasis (
                         (* primitive type constructors for \uml\ [[::]] 614d *)
                             ("int", inttycon, TYPE) :: 
                             ("sym", symtycon, TYPE) :: nil)
(* definitions of [[emptyBasis]], [[predefinedTypeBasis]], [[booltype]], [[listtype]], and [[unittype]] 613b *)
val predefinedTypeBasis =
  let val predefinedTypes =
               (* predefined {\uml} types, as strings (generated by a script) *)
...
(* definitions of [[emptyBasis]], [[predefinedTypeBasis]], [[booltype]], [[listtype]], and [[unittype]] 614c *)
local
...
(* exhaustiveness analysis for {\uml} 665a *)
...
(* exhaustiveness analysis for {\uml} ((prototype)) 665b *)
...
(* exhaustiveness analysis for {\uml} 666a *)
fun unroll tau =
...
(* exhaustiveness analysis for {\uml} ((prototype)) 666b *)
...
(* function [[ty]], to infer the type of a \nml\ expression, given [[Gamma]] 523a *)
      fun ty (LITERAL n) = literal n
        ...
        (* more alternatives for [[ty]] 595 *)
        | ty (CASE (e, choices)) = 
            let (* definition of function [[pvconType]] ((existentials)) 625b *)
                          ...
                          of NONE => sigma
                           | SOME (FORALL_EXISTS (alphas, betas, args, result))
                               ...
                               let val skolems = map freshSkolem betas
                                   val theta = tysubst (bindList (betas, skolems
                                                                    , emptyEnv))
                               in  FORALL (alphas, theta (funtype (args, result)
                                                                              ))
                               end
                  in  freshInstance sigma'
                  end handle NotFound x => raise TypeError (
                                              "no value constructor named " ^ x)
                (* definition of function [[pattype]] 597c *)
                fun pattype (WILDCARD, _) =
                      (emptyEnv, freshtyvar(), TRIVIAL)
                (* definition of function [[pattype]] 597d *)
                  | pattype (PVAR x, _) =
                ...
                (* definition of function [[pattype]] 598a *)
                  | pattype (CONPAT (K, []), Gamma) =
                      (emptyEnv, pvconType (K, Gamma), TRIVIAL)
                (* definition of function [[pattype]] 598c *)
                ...
                (* definition of function [[pattype]] 598d *)
                ...
                val _ = op pattypes : pat list * type_env -> type_scheme env
                                                       list * ty list * con list
                (* definition of function [[choicetype]] 597a *)
                fun choicetype ((p, e), Gamma) =
                      let val (Gamma', tau, c) = pattype (p, Gamma)
                          ...
                          val _ =
(* check [[p]], [[e]], [[Gamma']], [[Gamma]], [[ty]], and [[con]] for escaping skolem types ((existentials)) 626a *)
                                  let val theta = solve con
                                (* if exn is raised here, we're doomed anyway *)
                                      val patSkolems = typeSchemesFreeSkolems (
                                            map snd (typeEnvSubst theta Gamma'))
                                      val envSkolems = typesFreeSkolems (map (
                                        varsubst theta) (freetyvarsGamma Gamma))
                                      val tySkolems  = typeFreeSkolems  (tysubst
                                                                       theta ty)

             (* definitions of skolem functions [[fail]] and [[badType]] 627b *)
                                      fun fail ss =
                                        raise TypeError (concat (["in choice (",
                                    patString p, " ", expString e, "), "] @ ss))
                                      fun badType tau =
                                        concat ["type ", typeString tau,
                                                                     ", which ",
                                  ...
                                  in  case (inter (patSkolems, tySkolems), inter
                                        ...
                                        of (mu :: _,  _) =>
                                  (* fail with skolem escaping into type 626b *)
                                                            (case asFuntype (
                                                               tysubst theta ty)
                                                               of SOME ([tau],
                                                                        tau') =>
                                                                    if not (null
                                (inter (patSkolems, typeFreeSkolems tau'))) then
                                                                      fail [
                               ...
                               "scrutinee is constrained to have ", badType tau]
                                                                | _ => let
                       exception ChoiceTypeNotFun in raise ChoiceTypeNotFun end)
                                         | ([], mu :: _) =>
                           (* fail with skolem escaping into environment 627a *)
                                                            fail ["skolem type "
...
fun elabdef (d, Gamma) =
  case d
    of VAL    (x, e)      =>
     ...
     (* extra case for [[elabdef]] used only in \uml 1298c *)
...
(* evaluation, testing, and the read-eval-print loop for \uml 587b *)
...
(* definitions of [[match]] and [[Doesn'tMatch]] 591b *)
...
(* definition of [[testIsGood]] for \uml 1297 *)
(* definition of [[skolemTypes]] for languages with generated type constructors 1298b *)
val skolemTypes =
...
(* definitions of [[check{Expect,Assert,Error}Checks]] that use type inference 1273a *)
      ...
      fun outcome e = withHandlers (fn () => OK (eval (e, rho))) () (ERROR o
                                                                     stripAtLoc)
      (* [[asSyntacticValue]] for \uml 1298a *)
...
(* implementations of \uml\ primitives and definition of [[initialBasis]] 614a *)
...
(* implementations of \uml\ primitives and definition of [[initialBasis]] 614b *)
val initialBasis =
  let val predefinedFuns =
        (* predefined {\uml} functions, as strings (generated by a script) *)
