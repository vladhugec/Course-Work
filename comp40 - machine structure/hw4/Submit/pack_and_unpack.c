...
uint64_t packA(uint64_t word, double y1, double y2, double y3, double y4){
        ...
        uint64_t value = round(a * 511);
        uint64_t newWord = Bitpack_newu(word, 9, 23, value);
        return newWord;
}
...
uint64_t packB(uint64_t word, double y1, double y2, double y3, double y4){
        ...
        int64_t value = round(b / 0.02);
        uint64_t newWord = Bitpack_news(word, 5, 18, value);
        return newWord;
}
...
uint64_t packC(uint64_t word, double y1, double y2, double y3, double y4){
        ...
        int64_t value = round(c / 0.02);
        uint64_t newWord = Bitpack_news(word, 5, 13, value);
        return newWord;
}
...
uint64_t packD(uint64_t word, double y1, double y2, double y3, double y4){
        ...
        int64_t value = round(d / 0.02);
        uint64_t newWord = Bitpack_news(word, 5, 8, value);
        return newWord;
}
...
double unpackA(uint64_t word){
        uint64_t value = Bitpack_getu(word, 9, 23);
        double a = value / 511.0;
        return a;
}

double unpackB(uint64_t word){
        int64_t value = Bitpack_gets(word, 5, 18);
        double b = value * 0.02;
        return b;
}

double unpackC(uint64_t word){
        int64_t value = Bitpack_gets(word, 5, 13);
        double c = value * 0.02;
        return c;
}

double unpackD(uint64_t word){
        int64_t value = Bitpack_gets(word, 5, 8);
        double d = value * 0.02;
        return d;
}
