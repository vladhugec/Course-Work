...
*/
extern void initialize_UM_data(FILE *fp, UM_data data, SIZE numBytes);
...
*/
extern void UM_data_free(UM_data *data, SIZE numBytes);
...
extern uint32_t UM_data_get_zeroSeg_instruction(UM_data data, SIZE inner_i);

//extern uint32_t* UM_data_makeTOarray(UM_data data);
...
*/
extern int UM_data_get_seg_instruction_count(UM_data data, SIZE outer_i);
...
extern void printBits(uint32_t word);
...
*/
extern void UM_data_seg_put(UM_data data, SIZE* new_seg, SIZE loc);
